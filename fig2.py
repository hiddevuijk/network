...
plt.subplot(1,2,2)
plt.scatter(g,ddedg, color='blue', label=r"$K = \frac{ d^2 H}{d\gamma^2}$", facecolor='none')
plt.scatter(g,dedg, color='magenta', label=r"$\sigma= \frac{d H}{d \gamma}$", facecolor='none')
plt.scatter(g,e, color='red', label=r"$H$", facecolor='none')
